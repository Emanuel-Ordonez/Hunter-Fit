...
export class HomeComponent implements OnInit {
  ...
  public list_cardio_tips: Array<string> = [
  ...
  public list_weightlifting_tips: Array<string> = [
  ...
  public list_nutrition_tips: Array<string> = [
